...
class REYCircularLoader extends StatelessWidget {
  ...
  const REYCircularLoader({
    super.key,
    this.foregroundColor = REYColors.white,
    this.backgroundColor = REYColors.primary,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(REYSizes.lg),
